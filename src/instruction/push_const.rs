...
const_instruction! {dconst_0, 0xe, JavaValue::Double(0.0)}
const_instruction! {dconst_1, 0xf, JavaValue::Double(1.0)}
...
const_instruction! {lconst_0, 0x9, JavaValue::Long(0)}
const_instruction! {lconst_1, 0xa, JavaValue::Long(1)}
